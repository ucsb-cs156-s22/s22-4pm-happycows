...
describe("HomePage tests", () => {
  ...
  test("Redirects to the PlayPage when you click visit", async () => {
    ...
    expect(
      await screen.findByTestId("commonsCardVisit-button-Visit-1")
    ).toBeInTheDocument();
    const visitButton = screen.getByTestId("commonsCardVisit-button-Visit-1");
  ...
  test("Calls the callback when you click join", async () => {
    ...
    expect(
      await screen.findByTestId("commonsCard-button-Join-1")
    ).toBeInTheDocument();
