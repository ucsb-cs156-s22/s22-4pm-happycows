...
describe("UserTable tests", () => {
  ...
  test("Has the expected column headers and content for adminUser", () => {
    ...
    const expectedHeaders = ["id", "Name", "Cow Price", 'Milk Price', 'Starting Balance', 'Show Leaderboard', 'Starting Date'];
    const expectedFields = ["id", "name", "cowPrice", "milkPrice", "startingBalance", "showLeaderboard","startingDate"];
