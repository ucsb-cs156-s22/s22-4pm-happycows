  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        {
          hasRole(currentUser, "ROLE_ADMIN") && <Route path="/admin/leaderboard/:commonsId" element={<LeaderboardPage />} />
        }
        {
          hasRole(currentUser, "ROLE_USER") && <Route path="/play/leaderboard/:commonsId" element={<LeaderboardPage />} />
        }
