  ...
  return (
    <Card>
      ...
      <Card.Body>
        ...
        <Card.Title data-testid={"sell-price"}>
          Current Sell Price: $
          {(commons?.cowPrice * userCommons.avgCowHealth) % 1 === 0
            ? commons?.cowPrice * userCommons.avgCowHealth
            : (commons?.cowPrice * userCommons.avgCowHealth).toFixed(2)}
        </Card.Title>
